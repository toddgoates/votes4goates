      ...
      <main className="container mx-auto p-4 space-y-10">
        ...
        <Card>
          ...
          <div className="text-lg space-y-4">
            <p>
              Having recently turned 35 years of age and being a natural born
              citizen of this great nation, I declare that I am running to be
              the <Emphasis>President of the United States of America</Emphasis>
              !
            </p>
            <p>
              While I have traveled to several other countries around the world,
              I am fond of this particular bit of land that I was born on,
              therefore I have a desire to{" "}
              <span className="line-through decoration-red-500">rule</span> lead
              it into a new era of prosperity.
            </p>
            <p>
              I'm also launching{" "}
              <Emphasis>
              ...
              . You may think that's an acronym for Greatest Of All Time, and
              you'd be correct... but it also stands for Government of American
              Teamwork. Our color is green because that's Todd's favorite color
              and our mascot is a goat because Todd's last name is Goates.
            </p>
        ...
        <Card>
          ...
          <div className="text-lg space-y-4 mb-8">
            <p>
              Here are some of the things Todd Goates will deliver on day one of
              his presidency:
            </p>
            <ul className="list-disc pl-4">
              <li>
                I will have brought peace, freedom, justice, and security to my
                new Empire.
              </li>
              <li>
                I will have unlimited power and the ability to save those I love
                from dying.
              </li>
              <li>
          ...
          <div className="text-lg space-y-4">
            <p>
              "Todd is a great guy. I've known him for years and he's always had
              my back." - Guy Incognito
            </p>
            <p>
              "He's better than the other guys running for president." - Steve
              Harmon
            </p>
            <p>
        ...
        <Card>
          ...
          <p>
            We are in the process of setting up our e-commerce store. Fill out
            the form below to find out when the latest merch has dropped.
          </p>
          {message ? (
            <p className="text-gray-500 text-center italic my-10">{message}</p>
          ) : (
            <div className="my-10">
              <input
                type="email"
        ...
        <Card>
          ...
          <div className="text-lg space-y-4">
            <p>
              As you know, campaigns are expensive. If you want a regular person
              like me to win the white house, we're gonna need to make a lot of
              money... like seriously. Tons!
            </p>
            <div className="text-center my-8">
              <button
                className="bg-blue-500 px-3 py-2 text-white font-semibold rounded hover:bg-blue-700"
          ...
          <h2 className="text-2xl font-semibold mb-4">Money money money!</h2>
          <div className="text-lg space-y-4">
            <p>
              <span className="font-semibold">{donorName}</span> just donated{" "}
              <span className="font-semibold">${donationAmount}</span> to Todd's
              campaign!
            </p>
            <p>
              These are <Emphasis>real people</Emphasis> who want to see{" "}
              <Emphasis>real change</Emphasis> in this country. Trust me, they
              are real!
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="text-lg space-y-4">
            <p>
              If you want those fat cats in Washington to stop taking advantage
              of the little guy, then vote for{" "}
            ...
            <p>
              Because the older I get, the greater my odds are at winning the
              election!
            </p>
          </div>
        </Card>
